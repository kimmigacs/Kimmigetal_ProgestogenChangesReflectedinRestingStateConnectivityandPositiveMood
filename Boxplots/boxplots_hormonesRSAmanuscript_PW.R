# boxplots_hormonesRSAmanuscript.R
...
testosteronedelta_graph <- 
  ggboxplot(aa,
            x = "Group_deltaN", y = "hormonesdelta_data", 
...
res <- pw.wilcox.exact(aa$hormonesdelta_data, aa$Group_deltaN)
res[1:3, "p.adj.signif"] <- "ns" # Update significance labels if needed
...
## save plot
hi <- 3
png("HormonesGroupDiffboxplot.png", units="in", width=10, height=3, res=300)
...
#source("boxplots_hormonesRSAmanuscript_PW.R")
